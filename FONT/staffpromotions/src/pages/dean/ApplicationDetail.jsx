...
function ApplicationDetail() {
  ...
  const getHODComment = () => {
    if (!application) return "No HOD comment provided.";
  ...
  const submitReview = async (e) => {
    ...
    if (!decision) {
      setError(
        "Please select a Dean recommendation."
      );
      return;
    }
    ...
    try {
       ...
       * IMPORTANT:
       *
       * These values must match the Django
       * backend choices.
       */

      const payload = {
        dean_recommendation: decision,
        dean_comment: comment.trim(),
      };
      ...
      setSuccess(
        "Dean recommendation submitted successfully."
      );
    ...
    <div style={styles.page}>
      ...
      <div style={styles.reviewCard}>
        ...
        <p style={styles.reviewSubtitle}>
          ...
          documents and HOD recommendation before
